...
class MingcuteAiFill extends Component {
    ...
    render(props: { size: number; width?: number; height?: number }) {
        ...
        // Tạo một ID duy nhất cho gradient để tránh xung đột
        ...
        return (
            <svg
                ...
                {/* Bước 1: Định nghĩa gradient trong thẻ <defs> */}
                <defs>
                    <linearGradient id={gradientId} x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stop-color="#1cad86" />
                        <stop offset="100%" stop-color="#1c6ead" />
                    </linearGradient>
                </defs>
